...
| Ekran | İçerik |
|---|---|
| **Ana** | Şu anki konumum (aktif hafta, hafta tipi ve saati, borç), **kapsam taahhüdü** (çekirdek / kuyruk / kesildi dağılımı ve W26 kapısının durumu), sıradaki konular kuyruğu (parça sayacı ve tier rozetiyle), genel durumum (tamamlanan puan/**79**, beş hattın ayrı ilerleme çubuğu — payda hattın çekirdeği). |
